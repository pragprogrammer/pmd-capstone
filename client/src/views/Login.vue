<template>
  <div id="welcome-page">
    <div id="login">
      <form v-if="!newUser" @submit.prevent="loginUser" class="form-group">
      ...
      <h5><span @click="newUser = true" class="clickable">Register for an account</span></h5>
    </div>
    <div id="register">
      <form v-if="newUser" @submit.prevent="registerUser" class="form-group">
