    ...
    <v-dialog v-model="addPost" transition="dialog-bottom-transition">
        ...
        <v-card>
            ...
            <form @submit.prevent="verifyPost" id="form-body">
                <v-text-field v-model="post.title" maxlength="30" placeholder="title" type="string" required 
                v-validate="'required|max:30'"  data-vv-name="val.title" :error-messages="errors.collect('val.title')"></v-text-field> 
